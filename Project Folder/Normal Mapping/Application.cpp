...
HRESULT Application::Initialise(HINSTANCE hInstance, int nCmdShow)
{
	...
	gameObject->SetPosition(0.0f, 1.5f, 2.0f);
...
HRESULT Application::InitShadersAndInputLayout()
{
    ...
    hr = CompileShaderFromFile(L"NormalMapping.fx", "VS", "vs_4_0", &pVSBlob);
    ...
    hr = CompileShaderFromFile(L"NormalMapping.fx", "PS", "ps_4_0", &pPSBlob);
...
void Application::Update()
{
	...
	for (auto gameObject : _gameObjects)
	{
		gameObject->SetRotation(dwTimeCur * 0.001f, dwTimeCur * 0.001f, dwTimeCur * 0.001f);
