...
HRESULT Application::Initialise(HINSTANCE hInstance, int nCmdShow)
{
	...
	basicLight.SpecularPower = 34.0f;
	...
	shinyMaterial.specularPower = 34.0f;
...
HRESULT Application::InitShadersAndInputLayout()
{
	...
	hr = CompileShaderFromFile(L"SpecialEffectsPipeline.fx", "VS", "vs_4_0", &pVSBlob2);
	...
	hr = CompileShaderFromFile(L"SpecialEffectsPipeline.fx", "PS", "ps_4_0", &pPSBlob2);
...
void Application::Update()
{
	...
	for (auto gameObject : _gameObjects)
	{
		gameObject->SetRotation(dwTimeCur * 0.0001f, dwTimeCur * 0.0001f, /*dwTimeCur * 0.001f*/ 0.0f);
