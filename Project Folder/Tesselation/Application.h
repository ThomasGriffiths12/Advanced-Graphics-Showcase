...
private:
	...
	ID3D11VertexShader* _pSpecialEffectsVertexShader;
	ID3D11PixelShader* _pSpecialEffectsPixelShader;
	ID3D11HullShader* _pHullShader = nullptr;
	ID3D11DomainShader* _pDomainShader = nullptr;

	ID3D11InputLayout*      _pVertexLayout;
	ID3D11InputLayout*		_pSpecialEffectsInputLayout;
	...
	ID3D11Buffer* _pSpecialEffectsVertBuffer;
	ID3D11Buffer* _pSpecialEffectsIndexBuffer;
	...
	ID3D11ShaderResourceView * _pQuadTexRV = nullptr;

	ID3D11ShaderResourceView * _pTextureRV = nullptr;

	ID3D11ShaderResourceView * _pNormalRV = nullptr;

	ID3D11ShaderResourceView * _pDisplaceRV = nullptr;
	...
	//UINT _renderHeight = 2160;
	//UINT _renderWidth = 3840;
